...
<div class="container-fluid mt--6">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="mb-0">Top Header</h3>
        </div>
        <!-- Card body -->
        <div class="card-body">
            <form action="{{ route('top-header') }}" method="POST">
            @csrf
                <div class="form-group">
                    <textarea class="form-control" id="top_header" rows="2" name="top_header" resize="none">{{ $top_header->top_header }}</textarea>
                </div>
                <div class="col mt-3">
