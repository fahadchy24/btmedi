                            ...
                            @csrf
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="userType" name="userType" required>
                                      ...
                                      <option value="Subadmin">Retail</option>
                                      <option value="Manager">Medical Industry</option>
                                      <option value="Manager">School</option>
                                      <option value="Manager">Government</option>
                                      <option value="Manager">Non-Profit</option>
                                      <option value="Manager">General User</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="address_1" name="address_1" autocomplete="off" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="fax" name="fax" autocomplete="off" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="order_id">Note</label>
