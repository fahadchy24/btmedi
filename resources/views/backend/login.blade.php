...
<head>
  ...
  <title>BT Medi | Admin Login</title>
  <!-- Favicon -->
              ...
              @endif
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control @error('login') is-invalid @enderror" placeholder="Username or Email" type="text" name="login" value="{{ old('login') }}" required autocomplete="off">
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control @error('password') is-invalid @enderror" placeholder="Password" type="password" name="password" required autocomplete="off">
